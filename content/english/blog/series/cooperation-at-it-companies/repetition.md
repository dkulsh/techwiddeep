...
*Previously:* detection, nature, clarity, certainty, size (pillars 1–5). The last pillar is **repetition** — whether the game repeats changes how everyone plays it.
...
> **Principle**: A repeated game is played differently from a one-shot one — the fear of future losses is what keeps people honest now.
...
> **Idea**: A less talented but loyal employee can outvalue a brilliant but unreliable one.
...
**← Previous**: [Size for Cooperation](/blog/series/cooperation-at-it-companies/size/)

**Series Progress**: Part 7 of 7 | [View All Posts](/blog/series/cooperation-at-it-companies/)
