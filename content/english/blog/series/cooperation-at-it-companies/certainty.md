...
*Previously:* detection, nature, and clarity (pillars 1–3). Pillar 4 is **certainty** — a reward or penalty only shapes behaviour if people believe it will actually land.
...
*I worked with a large IT services firm for many years. Many times, my performance was pretty good (staying modest). However, I wasn't always rewarded.*
...
> **Principle**: Certainty triggers cooperation; uncertainty triggers collusion.
...
*Employees weren't certain whether their work would be rewarded anymore.* This reduced overall productivity — a loss far larger than the reward they dodged.

The organization saved a few thousand dollars, only to lose many times that. Penny wise, pound foolish!
...
**← Previous**: [Clarity for Cooperation](/blog/series/cooperation-at-it-companies/clarity/)  
**Next →**: [Size for Cooperation](/blog/series/cooperation-at-it-companies/size/)

**Series Progress**: Part 5 of 7 | [View All Posts](/blog/series/cooperation-at-it-companies/)
