...
**Total value** = Collection of all skills of an engineer (*This is an abstract concept. I've introduced it here to help people understand an idea. Please don't use it practically, or use it at your own peril* 😇😇)

**Formula:**

Total value = Tech skills × Communication skills × People skills × Awareness × Risk appetite × etc.

Individual skills themselves might be a collection of other skills. e.g.

*Tech = 2 (database) + 3 (backend) + 1 (frontend) = 6*

*Communication = 1 (English) + 3 (verbal) + 3 (written) = 7*

{{< figure src="/images/good-techies-bad-careers/tech-skills-breakdown.png" alt="Tech Skills Breakdown" >}}

{{< figure src="/images/good-techies-bad-careers/communication-skills-breakdown.png" alt="Communication Skills Breakdown" >}}
...
> **Principle**: Skills within domains *add* (e.g., backend + frontend), while across domains they *multiply* (e.g., tech * communication).
...
{{< bigtext >}}
With the multiplying effect, the total value comes down to Zero. This is what happened with Ravi!
{{< /bigtext >}}


{{< figure src="/images/good-techies-bad-careers/zero-skills-impact.png" alt="Zero Skills Impact" >}}
...
> **Actionable Takeaway**: Build *people skills* to complement technical talent and avoid self-sabotage.
...
{{< figure src="/images/good-techies-bad-careers/nerd-stereotype.jpg" alt="Nerd Stereotype" >}}
...
> **Actionable Takeaway**: Invest in *presentation* and *confidence* to elevate your perceived value.
...
{{< figure src="/images/good-techies-bad-careers/english-fear-example.jpg" alt="English Fear Example" >}}
...
> **Actionable Takeaway**: Improve *language skills* to ensure visibility and recognition in diverse teams.
...
{{< figure src="/images/good-techies-bad-careers/anger-management-issue.jpg" alt="Anger Management Issue" >}}
...
Did you notice: All engineers discussed were great at tech work.
...
Another objection to my explanation is - If all engineers have exactly the same skills-set, then they become xerox copies of one another. **They lose their unique value**.

Essentially they become replaceable bricks in industrial wall. But this is NOT what I mean. Let's take some engineers working at the same organization:

**The introvert:**

9 (Tech) × 7 (Comm.) × 2 (people skills) × 4 (presentation) × 2 (risk appetite) = **1008**

{{< figure src="/images/good-techies-bad-careers/image3-312w188h-300x181.png" alt="Introvert Profile" >}}

**The popular:**

2 (Tech) × 8 (Comm.) × 7 (people skills) × 8 (presentation) × 2 (risk appetite) = **1792**

{{< figure src="/images/good-techies-bad-careers/image2-312w187h-300x180.png" alt="Popular Profile" >}}

**The entrepreneurial:**

4 (Tech) × 4 (Comm.) × 4 (people skills) × 5 (presentation) × 8 (risk appetite) = **2560**

{{< figure src="/images/good-techies-bad-careers/image10-312w187h-300x180.png" alt="Entrepreneurial Profile" >}}
...
This is how we engineers think ...

{{< figure src="/images/good-techies-bad-careers/image1-374w225h-300x180.png" alt="Engineer Thinking" >}}

**Total Value = Database × Backend × Frontend × Version Control × IDEs × DevOps Tools**
...
{{< figure src="/images/good-techies-bad-careers/image13-300w181h.png" alt="Tech Skills Additive" >}}

**Then the domains have a multiplying effect.** Think...

{{< figure src="/images/good-techies-bad-careers/image15-374w225h-300x180.png" alt="Domains Multiplying" >}}
...
{{< figure src="/images/good-techies-bad-careers/image8-312w187h-300x180.png" alt="Pradeep's Skills" >}}
...
{{< figure src="/images/good-techies-bad-careers/image19-374w225h-300x180.png" alt="Skill Priority" >}}
...
- Students from *tier-1 colleges* like IITs or IIMs tend to mostly have great careers (*from what I have seen, not all IITans are bright*)
...
My understanding… These communities **understand the value of holistic skills more than others do.**
...
{{< figure src="/images/good-techies-bad-careers/image7-300x166.png" alt="Educational Advantage" >}}

I was educated in a convent school, and brought up in a small town. *I always had good English. But, I dressed like a fool*.

My English would've helped me in countless ways. Similarly, my poor dressing would've hurt me in many ways. (*after some feedback, I realized and corrected my error*)
...
{{< figure src="/images/good-techies-bad-careers/image6.jpg" alt="Next Steps" >}}
