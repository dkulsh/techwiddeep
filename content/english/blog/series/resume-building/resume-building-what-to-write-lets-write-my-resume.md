...
- **Experience**: Nearly 10 years in the tech industry.
- **Technology Focus**: Backend and middle-layer technologies (minimal frontend work).
- **Technologies**: Java (Spring, EJB, Struts), Data Structures, Multithreading, Oracle, DB2, Unix.
- **Organizations**: Primarily service industry, some product industry exposure.
- **Domain**: Banking and capital markets.
- **Work Type**: Developer, designer, bug fixing, performance improvement.
- **Achievements**: Awards, recognitions, and successful project deliveries.

With these in mind, I'll craft my profile summary.

{{< figure src="/images/resume-building/what-to-write-lets-write/summary-first-draft.jpg" alt="Summary first draft example"  >}}
...
> **Principle**: Focus on relevance. With more experience, education matters less.

{{< figure src="/images/resume-building/what-to-write-lets-write/education-section.jpg" alt="Education section approach"  >}}
...
- I omitted college/school names and locations because they're not important for my profile. If yours are relevant (e.g., a Tier 1 institution), include them.
...
{{< figure src="/images/resume-building/what-to-write-lets-write/skills-timeline.jpg" alt="Skills timeline approach"  >}}
...
{{< bigtext >}}A strong tech vocabulary with a modest but honest skillset is more valuable than exaggerated claims.{{< /bigtext >}}
...
{{< figure src="/images/resume-building/what-to-write-lets-write/work-details-focus.jpg" alt="Work details focus areas"  >}}
...
{{< figure src="/images/resume-building/what-to-write-lets-write/project-examples.jpg" alt="Project examples showcase"  >}}
...
{{< figure src="/images/resume-building/what-to-write-lets-write/project-notes.png" alt="Project notes and guidelines"  >}}

**Notes**:
- I could list more projects, but **recruiters stop reading after a few**. I'll focus on polishing these.
...
{{< figure src="/images/resume-building/what-to-write-lets-write/wrapping-up.jpg" alt="Wrapping up the first draft"  >}}

This is the first draft of my resume's key sections. **It's far from perfect—and that's okay.**
