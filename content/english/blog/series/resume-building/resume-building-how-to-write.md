...
- **Step 1: Gather Raw Details**—Write everything that comes to mind, like a "word vomit"
...
{{< figure src="/images/resume-building/how-to-write/brevity-examples.png" alt="Brevity examples"  >}}
...
{{< figure src="/images/resume-building/how-to-write/english-help.jpg" alt="English language help"  >}}
...
1. What was the *cost* or *budget* of your project?
2. What *profit* did your work generate (or is expected to generate)?
3. What’s the *size of data* handled (e.g., millions of records, terabytes)?
4. How many *users* does the system support (total or concurrent)?
5. How *faster* was your work compared to others (e.g., 50% faster)?
6. How much *time* was saved (e.g., system runtime or build time)?
7. What’s the *cost* or *scale* of the server environment?
8. How much *automation* was achieved (e.g., hours saved)?
9. How many *bugs* were caught or *critical issues* avoided (as a percentage)?

{{< figure src="/images/resume-building/how-to-write/quantification-questions.png" alt="Quantification questions"  >}}
...
{{< figure src="/images/resume-building/how-to-write/manager-questions.jpg" alt="Manager questions"  >}}
...
{{< figure src="/images/resume-building/how-to-write/vocabulary-guidelines.png" alt="Vocabulary guidelines"  >}}
...
> **Principle**: Choose industry terms over implification to maintain credibility.
...
{{< figure src="/images/resume-building/how-to-write/editing-example.jpg" alt="Editing example" >}}
...
Now that we understand *brevity*, *quantification*, and *vocabulary*, we can edit the resume content from the previous blog. The goal is to:
- Shorten long sentences.
- Add *numbers* to show impact.
- Incorporate *technical vocabulary* for clarity and professionalism.

We’ll refine the draft in the next section, ensuring it’s *concise*, *measurable*, and *technically precise*.
