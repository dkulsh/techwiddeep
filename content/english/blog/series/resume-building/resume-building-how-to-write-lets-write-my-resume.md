...
{{< figure src="/images/resume-building/how-to-write-lets-write/profile-summary-observations.jpg" alt="Profile summary observations"  >}}


**Observations**:
- It's brief and quantifies some aspects (e.g. *team size 3-10*).
...
**Improvements Needed**:
- Add *business-relevant details* (e.g., cost savings, revenue impact).
- Include more *quantifiable metrics* to clarify scope and impact.
- Highlight *performance metrics* to sell achievements.

{{< figure src="/images/resume-building/how-to-write-lets-write/improvements-needed.jpg" alt="Improvements needed" >}}

We need to add more business-relevant details and performance metrics.
...
{{< figure src="/images/resume-building/how-to-write-lets-write/education-guidelines.png" alt="Education guidelines" >}}
...
{{< figure src="/images/resume-building/how-to-write-lets-write/skills-categorization.png" alt="Skills categorization" >}}
...
{{< figure src="/images/resume-building/how-to-write-lets-write/work-details-refinement.png" alt="Work details refinement" >}}
...
**Observations**:
- Limited *quantification* (no specific metrics).
- Unclear *business value* of contributions.
- Achievements not ordered by *impact*.
...
**Notes**:
- Added *metrics* (e.g., *18MB leak*, *70% improvement*).
- Prioritized *high-impact tasks* at the top.
- Used *technical vocabulary* (e.g., *overdraw*, *AsyncTasks*).

> **Idea**: A strong vocabulary enhances credibility, even if your tech stack is modest.

A robust vocabulary impresses recruiters. Pay attention to industry terms. **It is like purchasing credibility with the "payment of attention"**
...
**Observations**:
- Limited *quantification* beyond build time reduction.
...
**Notes**:
- Added *project budget* (*$150K*) for scope.
- Highlighted *quantified impact* (e.g., *90% time reduction*).
- Removed vague (*data structures*) and redundant (*CI/CD pipeline*, *Tomcat cost*) details for brevity.

---

The projects can be ordered by :
...
{{< figure src="/images/resume-building/how-to-write-lets-write/polishing-presentation.png" alt="Polishing presentation" >}}

Until then, happy refining!
