...
Sometimes, the reason is that rewarding problem-solvers promote the problems themselves.
...
> Most avoidance work is invisible.



##### The Glory Gap

Do you focus on killing cobras or also on avoiding them? Do you choose invisible tasks or only visible ones?
...
{{< bigtext >}}Want more salary? Start taking more ownership!{{< /bigtext >}}
...
##### Smart Signals, Not Perverse Prizes

If the number of bugs solved is a performance signal, then **the absence of bugs is also a performance signal.**

I believe signals should be appreciated but not rewarded. If they are, signaling becomes the goal, not the work. For example:
